...
export function MenuScreen({ restaurantId, onBack }) {
  const { addItem, removeItem, getItemQuantity, errorMessage: cartError, loadCart } = useCartStore();
  ...
  useEffect(() => {
    ...
    loadData();
  }, [restaurantId, getRestaurantById, loadCart]);
  ...
  const handleAddItem = async (item) => {
    ...
    if (result?.code === CART_RESTAURANT_CONFLICT) {
      alert('Your cart has items from another restaurant. Clear your cart to add from this restaurant.');
    }
  };
                ...
                <div key={item.id} className="menu-item-card">
                  ...
                  <div className="menu-item-right">
                    {item.image ? (
                      ...
                      <div className="menu-item-image-fallback-small">🍽️</div>
                    )}
